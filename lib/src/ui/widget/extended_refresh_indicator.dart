...
class ExtendedRefreshIndicator extends StatefulWidget {
  ...
  @override
  ExtendedRefreshIndicatorState createState() =>
      ExtendedRefreshIndicatorState();
}

/// Contains the state for a [RefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class ExtendedRefreshIndicatorState extends State<ExtendedRefreshIndicator>
    with TickerProviderStateMixin<ExtendedRefreshIndicator> {
